...
Use template from `/home/solomon/finance-visualizer/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/solomon/finance-visualizer/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/solomon/finance-visualizer/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
