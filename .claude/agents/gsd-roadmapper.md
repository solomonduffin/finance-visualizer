...
Reference full template: `/home/solomon/finance-visualizer/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/solomon/finance-visualizer/.claude/get-shit-done/templates/state.md`.
