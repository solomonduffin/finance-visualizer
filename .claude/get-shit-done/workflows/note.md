...
- **Global scope**: `/home/solomon/finance-visualizer/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/solomon/finance-visualizer/.claude/notes/`)
...
2. Glob `/home/solomon/finance-visualizer/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/solomon/finance-visualizer/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/solomon/finance-visualizer/.claude/notes/` — works in any directory
