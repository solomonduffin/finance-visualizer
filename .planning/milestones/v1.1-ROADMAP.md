...
- ✅ **v1.1 Enhancements** - Phases 5-9 (shipped 2026-03-17)
...
<details>
<summary>✅ v1.1 Enhancements (Phases 5-9) — SHIPPED 2026-03-17</summary>
...
- [x] **Phase 6: Operational Quick Wins** - Sync failure diagnostics in settings and growth rate indicators on panel cards (completed 2026-03-16)
- [x] **Phase 7: Analytics Expansion** - Custom account groups and dedicated net worth drill-down page (completed 2026-03-16)
- [x] **Phase 8: Alert System** - Expression-based alert rules with 3-state machine and email notifications via SMTP (completed 2026-03-17)
- [x] **Phase 9: Projection Engine** - Forward-looking net worth projections with per-account APY, reinvestment, and income modeling (completed 2026-03-17)
...
Plans:
- [x] 06-01-PLAN.md — Backend API: sync log endpoint with sanitization, growth calculation endpoint with shopspring/decimal, settings toggle, TypeScript client types
- [x] 06-02-PLAN.md — Settings page: SyncHistory timeline component with expand/collapse errors, DashboardPreferences toggle section
- [x] 06-03-PLAN.md — Dashboard: GrowthBadge component with tooltip and invisible placeholder, PanelCard integration, parallel data fetching
...
Plans:
- [x] 07-01-PLAN.md — Account groups backend: database migration, CRUD API endpoints, extend GetAccounts/GetGrowth with group data
- [x] 07-02-PLAN.md — Net worth page: backend API endpoint with time-series and stats, frontend page with stacked area chart, stats bar, time range selector, donut click navigation, nav link
- [x] 07-03-PLAN.md — Account groups frontend: GroupRow component, PanelCard group support, AccountsSection group management with drag-and-drop, Dashboard data flow
...
Plans:
- [x] 08-01-PLAN.md — Core alert engine: database migration (alert_rules, alert_history), Go dependencies (expr-lang/expr, go-mail), expression evaluator, AES-256-GCM crypto, 3-state machine engine, SMTP notifier with tests
- [x] 08-02-PLAN.md — Backend API: alert CRUD handlers, email config/test handlers, router registration, post-sync evaluation hook
- [x] 08-03-PLAN.md — Frontend: API client alert/email types, AlertRuleForm expression builder, AlertRuleCard with status/toggle/history, Alerts management page
- [x] 08-04-PLAN.md — Frontend integration: App.tsx route and nav link, Settings Email Configuration section, visual verification
...
| 6. Operational Quick Wins | v1.1 | 3/3 | Complete | 2026-03-16 |
| 7. Analytics Expansion | v1.1 | 3/3 | Complete | 2026-03-16 |
| 8. Alert System | v1.1 | 4/4 | Complete | 2026-03-17 |
| 9. Projection Engine | v1.1 | 5/5 | Complete | 2026-03-17 |
