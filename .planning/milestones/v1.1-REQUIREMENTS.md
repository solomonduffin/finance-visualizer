...
- [x] **ACCT-05**: User can expand an account group to see individual account balances beneath it
...
- [x] **ALERT-05**: User can configure email provider in settings (SMTP or API service with provider-specific fields)
- [x] **ALERT-06**: User can send a test email to verify configuration
...
| ALERT-05 | Phase 8 | Complete |
| ALERT-06 | Phase 8 | Complete |
